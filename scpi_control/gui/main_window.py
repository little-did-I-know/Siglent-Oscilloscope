...
if TYPE_CHECKING:
    from scpi_control.gui.vnc_window import VNCWindow
...
try:
    from scpi_control.gui.widgets.waveform_display_pg import WaveformDisplayPG as WaveformDisplay
...
from scpi_control.gui.widgets.error_dialog import DetailedErrorDialog
...
class MainWindow(QMainWindow):
    ...
    def _create_control_panel(self) -> QWidget:
        ...
        try:
            from scpi_control.gui.widgets.vector_graphics_panel import VectorGraphicsPanel
